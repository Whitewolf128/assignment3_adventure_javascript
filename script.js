                                ...
                                if(true){
                                    ...
                                    btn2.addEventListener('click', () =>{
                                        if(true){
                                            ...
                                            para.textContent = "";
                                            para.innerHTML += "You have chosen the name SkullBringer<br><br>The name has stuck and now to make an album and put on a show.<br>Click next to continue.";
                                            btnNext.addEventListener('click', () => {
                                                if(true){
                                                    btnNext.style.display ="none";
                                                    btnRetry.style.display = "none";
                    ...
                    if(true){
                        ...
                        btnNext.addEventListener('click', () =>{
                            if(true){
                                ...
                                btn1.style.display = "block";
                                btn2.style.display = "block";
                                para.textContent = "time to make music, do you use a computer or learn each instrument and play backing tracks with a dj?";
                                ...
                                btn2.addEventListener('click', () =>{
                                    if(true){
                                        ...
                                        btnNext.style.display = "block";
                                        btnRetry.style.display = "none";
                                        para.textContent = "You teach yourself all instruments for your music and fans like it a bit better live.<br><br>Click next to continue.";
                                        btnNext.addEventListener('click', () =>{
                                            if(true){
                                                btn1.style.display = "block";
                                                btn2.style.display = "block";
                            ...
                            if(true){
                                    ...
                                    if(true){
                                        ...
                                        btnNext.addEventListener('click', () =>{
                                            if(true){
                                                ...
                                                btnNext.style.display = "none";
                                                btnRetry.style.display = "none";
                                                para.textContent = "You and the group dance to each song while a band plays, the manager asks you if you can allow some fans who buy VIP tickets on stage to join you, do you agree?";
                                                btn1.textContent = "Yes";
                                                btn2.textContent = "No";
                                                btn1.addEventListener('click', () =>{
                                                    if(true){
                                ...
                                btn2.addEventListener('click', () =>{
                                    if(true){
                                        ...
                                        btnNext.style.display = "block";
                                        btnRetry.style.display = "none";
                                        para.textContent = "You allow the fans to join in on the catchy lyrics and make up dances on their own whilst you play instruments.<br>Click next to continue.";
                                        btnNext.addEventListener('click', () =>{
                                            if(true){
                                                btn1.style.display = "block";
                                                btn2.style.display = "block";
                                                ...
                                                btn1.addEventListener('click', () =>{
                                                    if(true){
                                                        ...
                                                        btnNext.style.display = "none";
                                                        btnRetry.style.display = "block";
                                                        para.textContent = "You decide to branch out to play with other bands to hopefully show others that your music is good too.<br><br>Collaberator ending.";
                                                        btnRetry.addEventListener('click', load);
                                            ...
                                            if(true){
                                                ...
                                                btn2.addEventListener('click', () =>{
                                                    if(true){
                                                        ...
                                                        btnNext.style.display = "none";
                                                        btnRetry.style.display = "block";
                                                        para.textContent = "Your band does not get alot of love in most countries due to the language barrier and not very well recieved in europe either meaning after a few years you would have to break up.<br><br>Not loved ending.";
                                                        btnRetry.addEventListener('click', load);
                                                    }
                                                });
                                            }
                                            ...
                                            if(true){
                                                ...
                                                btn2.addEventListener('click', () =>{
                                                    if(true){
                                                        ...
                                                        btnNext.style.display = "none";
                                                        btnRetry.style.display = "block";
                                                        para.textContent = "Your band does gets loved by many countries due to the grooviness of the sound some understand the lyrics and say its more relatable and others love the rythem even though they dont know the lyrics.<br><br>loved ending.";
                                                        btnRetry.addEventListener('click', load);
                                                    }
                                                });
                                            }
